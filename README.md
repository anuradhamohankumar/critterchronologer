...
4. The project should open in IDEA. In the project structure, navigate to `src/main/java/com.udacity.jwdnd.critterchronologer`. 
5. Within that directory, click on CritterApplication.java and select `Run` -> `Debug CritterchronologerApplication`. 
...
1. Within your project in IDEA, Navigate to `src/test/java/com.udacity.jwdnd.critterchronologer`.
